...
<body class="app">
  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
    ...
    <div class="app-wrapper">
		...
		<div class="container">
		<div class="col-auto">
			            <h1 class="app-page-title mb-0">Ajouter le produit</h1>
				    </div>
    <div class="row justify-content-center align-items-center" style="min-height: 30vh;">
    
        <div class="col-6 text-center">
            					<div class="text-start mx-auto">
							  <form action="ServletAddProduit" method="post"enctype="multipart/form-data">       
							<div class="mb-3">
								<label for="nom" class="form-label">Nom</label>
    							<input type="text" class="form-control" id="nom" name="nom" aria-describedby="prodt" required>
    							<br>
    							<label for="prix" class="form-label">Prix</label>
    							<input type="text" class="form-control" id="prix" name="prix" aria-describedby="price" required>
    							<br>
    							<label for="quantite" class="form-label">Quantité Dispo</label>
    							<input type="text" class="form-control" id="quantite" name="quantity_dispo" aria-describedby="quantity" required>
    							<br>
