...
<body class="app">   	
    <header class="app-header fixed-top">	   	            
	  ...
	  <path fill-rule="evenodd" d="M6 1H1v3h5V1zM1 0a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1H1zm14 12h-5v3h5v-3zm-5-1a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1h-5zM6 8H1v7h5V8zM1 7a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1V8a1 1 0 0 0-1-1H1zm14-6h-5v7h5V1zm-5-1a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1h-5z"/>
					    ...
					    <li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link active" href="ServletCommandes">
						        <span class="nav-icon">
						    ...
						    <div class="app-card-body">
							    <div class="table-responsive">
							        <table class="table app-table-hover mb-0 text-center">
										<thead>
											<tr>
												<th class="cell">IdCommande</th>
												<th class="cell">DateCommande</th>
												<th class="cell">NomClient</th>
												<th class="cell">Status</th>
											</tr>
										</thead>
										<tbody>
<c:forEach var="e" items="${listComd}">
										
											<tr>
												<td class="cell">${e.idCommande}</td>
												<td class="cell"><span class="cell-data">${e.created_at}</span></td>
												<td class="cell">${e.user.nom}</td>
