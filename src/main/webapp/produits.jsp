...
<tr>
												...
												<td class="cell"><span class="truncate">${e.categorie.title }</span></td>
												<td class="cell">
												 <a class="btn btn-sm" href="ServletUpdateProduit?idProduit=${e.idProduit}">
                                                      <i  class="fa fa-pen-to-square fa-lg" style="color: #46cf20"></i>
                                                 </a>
												</td>
												<td class="cell">
												<a class="btn btn-sm" href="ServletDeleteProduit?idProduit=${e.idProduit}">
